...
@app.route('/names')
def names():
    #inspect and get all of the sample column objects
    ...
    #extract the names of each sample object and append to list
    sample_names= []
    for names in sample_columns:
        sample_names.append(names["name"])

    #skip the first value in the list and return the json 
